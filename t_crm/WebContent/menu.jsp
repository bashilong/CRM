									...
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/jsp/linkman/add.jsp" target=main>－ 新增联系人</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall>
									...
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0 cellPadding=2 width=155 align=center border=0>
											<TBODY>
												...
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/saleVisit_findByPage.action" target=main>－客户拜访列表</A>
													</TD>
												</TR>
											</TBODY>
										</TABLE>
