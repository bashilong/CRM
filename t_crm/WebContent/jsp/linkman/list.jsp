...
<script type="text/javascript">
	$(function(){
		...
		$.get(url,function(result){
			...
			var oldVal1 = "${lkm_gender}";
			$("#customer").find("option[value='"+oldVal+"']").attr("selected","selected");
			$("#gender").find("option[value='"+oldVal1+"']").attr("selected","selected");
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>联系人名称：</TD>
													<TD>
														<s:textfield class="textbox" id="sChannel2" style="WIDTH: 80px" maxLength="50" name="lkm_name"/>
													</TD>
													...
													<TD>手机：</TD>
													<TD>
														<s:textfield class="textbox" id="sChannel2" style="WIDTH: 80px" maxLength="50" name="lkm_mobile"/>
													</TD>
													
													<TD>邮箱：</TD>
													<TD>
														<s:textfield class="textbox" id="sChannel2" style="WIDTH: 80px" maxLength="50" name="lkm_email"/>
													</TD>
													
													<TD>QQ：</TD>
													<TD>
														<s:textfield class="textbox" id="sChannel2" style="WIDTH: 80px" maxLength="50" name="lkm_qq"/>
													</TD>
