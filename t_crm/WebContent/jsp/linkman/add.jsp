...
<BODY>
	<FORM id=form1 name=form1 action="${pageContext.request.contextPath }/linkMan_save" method=post>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>联系人性别：</td>
								<td>
									<input type="radio" value="男" name="lkm_gender" checked>男
							...
							<TR>
								<td>联系人QQ ：</td>
								<td>
									<INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="lkm_qq">
								</td>
								<td>联系人简介 ：</td>
								<td colspan="2">
