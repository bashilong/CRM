...
$(function(){
	loadDict("001","#cust_industry","${editCustomer.cust_industry.dict_id}");
	loadDict("002","#cust_source","${editCustomer.cust_source.dict_id}");
	loadDict("006","#cust_level","${editCustomer.cust_level.dict_id}");
})
</script>
</HEAD>
<BODY>
