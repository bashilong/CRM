					...
					<td valign="top" width="100%" bgcolor="#ffffff">
						...
						<table bordercolor="#cccccc" cellspacing="0" cellpadding="0"
							...
							<tbody>
									...
									<td height="25">
										<table cellspacing="0" cellpadding="2" border="0">
											<tbody>
												<tr>
													<td>客户名称：</td>
													<td><select id="customer" name="customer.cust_id" class="textbox"
															...
															<s:iterator var="customer" value="customers">
																<s:if test="customer.cust_id==#customer.cust_id">
																	<option
																		...
																		selected="selected">
																		<s:property value="#customer.cust_name" /></option>
																</s:if>
																<s:else>
																	<option
																		value='<s:property value="#customer.cust_id" />'>
													...
													<td>拜访时间：</td>
													<td><s:textfield class="textbox" id="startTimeId"
															style="width: 140px" name="start_visit_time"
															readonly="readonly" /> - <s:textfield class="textbox"
								...
								<tr>
									<td><%@include file="/jsp/page.jsp" %></td>
								</tr>
							</tbody>
						</table>
					</td>
